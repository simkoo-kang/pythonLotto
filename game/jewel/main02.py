        ...
        if event.type == pygame.QUIT:
            ...
            if my > SCORE_PANEL_HEIGHT:
                ...
                if 0 <= r < GRID_SIZE and 0 <= c < GRID_SIZE:
                    # 💡 [버그 완벽 수정] 누르는 순간에는 폭발시키지 않고, 드래그할 수도 있으니 우선 좌표만 기억합니다!
            ...
            # 💡 마우스를 누른 채 사방으로 18픽셀 이상 '밀었을 때만' 드래그 스왑 상태로 진입합니다.
